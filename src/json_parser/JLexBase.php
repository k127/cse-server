...
class JLexBase {
  ...
  protected $jsonParser;
    ...
    function __construct($stream, JSONParser $jsonParser = null) {
  ...
  protected function yy_error($code, $fatal) {
    ...
    flush();
    if ($fatal) throw new JSONParserException($this->jsonParser, "JLex fatal error " . self::$yy_error_string[$code]);
  }
